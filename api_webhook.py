...
FAQ_CACHED_ANSWERS = {
    ...
    "โปรโมชั่นสำหรับลูกค้า SE Life" : "สิทธิพิเศษสำหรับลูกค้า SE Life วัคซีนป้องกันโรค จากโรงพยาบาลพญาไท 2 ราคาพิเศษ 690 บาท (จากปกติ 2,082 บาท)",
    "โปรโมชั่นสำหรับลูกค้า อินทรประกันภัย" : "รับฟรีเครื่องดื่มพันธุ์ไทย 1 แก้ว เมื่อแจ้งเคลมประกันรถยนต์ (เคลมแห้ง) สะดวกทุกที่ ทุกเวลา ผ่านไลน์ THAI GROUP สิทธิพิเศษสำหรับลูกค้า IN-SURE อินทรประกันภัย รับฟรีเครื่องดื่มพันธุ์ไทย 1 แก้ว (มูลค่า 50 บาท)"
}
...
def build_quick_reply() -> QuickReply:
    ...
    items = [
        QuickReplyItem(
            action=MessageAction(label=label, text=label)  # label ≤ 20 chars for LINE UI
        )
